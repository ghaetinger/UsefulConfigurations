...
myWorkspaces = map show [1..6] ++ [chrome, mail, spotify]
...
myStartupHook = do
    ...
    spawnOn spotify "spotify"
    -- spawn "polybar -r bar && xdo lower $(xwininfo -name polybar-bar_LVDS-1 | rg 'window id' | cut -d ' ' -f4)"
------------------------------------------------------------------------
...
main = do
    ...
    xmonad $ ewmh $ docks $ def {
      ...
      [
        ((mod4Mask, xK_e), spawn "emacsclient -a '' -c"),
        ((mod4Mask, xK_l), spawn "flameshot gui"),
